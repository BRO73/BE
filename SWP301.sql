...
CREATE DATABASE IF NOT EXISTS swp301;

-- 2. Chọn database đó để làm việc
USE swp301;

-- 3. TẮT KIỂM TRA KHÓA NGOẠI (ĐỂ CHẠY 1 NÚT BẤM)
SET FOREIGN_KEY_CHECKS = 0;

--
-- XÓA TẤT CẢ CÁC BẢNG (Bảng con xóa trước, bảng cha xóa sau)
--
...
--
-- BẮT ĐẦU TẠO CÁC BẢNG CHA (KHÔNG PHỤ THUỘC)
--
...
-- Dữ liệu cho bảng roles (ĐÃ SỬA LỖI 4.NULL -> 4,NULL)
...
--
-- BẮT ĐẦU TẠO CÁC BẢNG CON (PHỤ THUỘC)
--

--
-- Cấu trúc bảng menu_items (phụ thuộc categories)
--
...
--
-- Cấu trúc bảng users (phụ thuộc stores)
--
CREATE TABLE users (
                       id bigint NOT NULL AUTO_INCREMENT,
                       created_by bigint DEFAULT NULL,
...
--
-- BẮT ĐẦU TẠO CÁC BẢNG PHỤ THUỘC CẤP 2
--

--
-- Cấu trúc bảng role_permissions (phụ thuộc permissions, roles)
--
...
--
-- Cấu trúc bảng customers (phụ thuộc users)
--
...
--
-- Cấu trúc bảng floor_elements (ĐÃ SỬA CÁC CỘT _by SANG BIGINT)
--
...
-- Dữ liệu cho bảng floor_elements (*** ĐÃ SỬA LỖI NGÀY '2025-1all_05...' ***)
...
--
-- Cấu trúc bảng staff (phụ thuộc stores, users)
--
CREATE TABLE staff (
                       id bigint NOT NULL AUTO_INCREMENT,
                       is_activated tinyint(1) DEFAULT '1',
...
--
-- Cấu trúc bảng user_roles (phụ thuộc roles, users)
--
...
--
-- Cấu trúc bảng orders (phụ thuộc promotions, users, tables)
--
CREATE TABLE orders (
                        id bigint NOT NULL AUTO_INCREMENT,
                        created_by bigint DEFAULT NULL,
...
--
-- Cấu trúc bảng bookings (phụ thuộc users, tables)
--
...
--
-- Cấu trúc bảng support_requests (phụ thuộc users, tables)
--
...
--
-- BẮT ĐẦU TẠO CÁC BẢNG PHỤ THUỘC CẤP 3 (PHỤ THUỘC CÁC BẢNG TRÊN)
--

--
-- Cấu trúc bảng order_details (phụ thuộc menu_items, orders)
--
...
--
-- Cấu trúc bảng reviews (phụ thuộc orders, users)
--
...
--
-- Cấu trúc bảng transactions (phụ thuộc orders, users)
--
...
--
-- Cấu trúc bảng booking_tables (phụ thuộc bookings, tables)
--
...
-- Dữ liệu cho bảng booking_tables
